...
class tableSpider(scrapy.Spider):
    ...
    def parse(self, response):
        print("### Start date:", self.sdate)
        url = 'https://api.benzinga.com/api/v2.1/calendar/dividends?token=1c2735820e984715bc4081264135cb90&parameters[date_from]={}&parameters[date_to]=2023-03-25&parameters[date_sort]=ex&pagesize=1000'.format(self.sdate)
